...
def test_verify_subscription_home_page(base_url, browser):
    ...
    with allure.step("6. Verify success message 'You have been successfully subscribed!' is visible"):
